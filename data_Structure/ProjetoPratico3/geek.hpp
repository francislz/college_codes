...
class Arquivo{
    ...
    public:
        ...
        void Imprimir();
        void ImprimirTodos();
        int CopiaArquivo(fstream& arqE);
        void MergeSort(ofstream& arqS);
        bool Comparar(char nome1[], char nome2[]);
        bool Comparar(char nome1[], char nome2[], int i);
        void ImprimirArquivo(fstream& arqS);
