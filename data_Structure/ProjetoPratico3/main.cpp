...
int main(){
    ...
    do{
        ...
        cout << "5 - Ordenar Por Ano de Lancamento" << endl;
        cout << "0 - Sair" << endl;
        cin >> opc;
        ...
        switch(opc){
            ...
            case 5:{
                cout << "entrou";
                //Realizar uma ordenação por ano
                //Cria um arquivo para guardar os registros ordenados
                {
                    ofstream arqS("arquivoSaida.dat", ios::binary);
                    arquivo.MergeSort(arqS);
                    if(arqS) cout << "Abriu sa porra" << endl;
                    arqS.close();
                }
                fstream arqS("arquivoSaida.dat", ios::binary);

                //função de ordenacao MergeSort Externo
                //Imprime os Registros ordenados ordenados
                arquivo.ImprimirArquivo(arqS);
                break;
        ...
        cout << "A opcao escolhida foi" << opc << endl;
    }while(opc != 0);
}
