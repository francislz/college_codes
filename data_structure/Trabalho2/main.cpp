    ...
    do{
        ...
        switch(opc){
            ...
            case 2:{//Opcao de remover
                ...
                int id;
                cin >> id;
                int pos = arquivo.Buscar(id);
                if(pos != -1){ //Verifica se o ID a ser removido existe na base de dados
            ...
            case 3:{//Opcao de Buscar
                ...
                int idBusca;
                cin >> idBusca;
                int pos = arquivo.Buscar(idBusca);
                if(pos != -1){
                    Geek busca = arquivo.LerGeek(pos);
                    busca.Imprimir();
                }
                else{
                    cout << "Saga nao encontrada!" << endl;
